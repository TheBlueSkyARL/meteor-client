...
public abstract class PostProcessShader {
    ...
    protected PostProcessShader(RenderPipeline pipeline) {
        ...
        this.framebuffer = new SimpleFramebuffer(MarisaOptimize.NAME + " PostProcessShader " + this.getClass().getSimpleName(), mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight(), true);
    }
