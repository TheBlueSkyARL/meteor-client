...
package com.hongminh54.marisaoptimize.gui.renderer;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(MarisaOptimize.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(MarisaOptimize.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(MarisaOptimize.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(MarisaOptimize.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(MarisaOptimize.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(MarisaOptimize.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(MarisaOptimize.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(MarisaOptimize.identifier("textures/icons/gui/paste.png"));
