...
package com.hongminh54.marisaoptimize;

import com.hongminh54.marisaoptimize.addons.AddonManager;
import com.hongminh54.marisaoptimize.addons.MeteorAddon;
...
import com.hongminh54.marisaoptimize.gui.WidgetScreen;
import com.hongminh54.marisaoptimize.gui.tabs.Tabs;
import com.hongminh54.marisaoptimize.systems.Systems;
import com.hongminh54.marisaoptimize.systems.config.Config;
import com.hongminh54.marisaoptimize.systems.hud.screens.HudEditorScreen;
...
import com.hongminh54.marisaoptimize.systems.modules.misc.DiscordPresence;
import com.hongminh54.marisaoptimize.utils.PostInit;
import com.hongminh54.marisaoptimize.utils.PreInit;
import com.hongminh54.marisaoptimize.utils.ReflectInit;
import com.hongminh54.marisaoptimize.utils.Utils;
import com.hongminh54.marisaoptimize.utils.misc.Version;
import com.hongminh54.marisaoptimize.utils.misc.input.KeyAction;
import com.hongminh54.marisaoptimize.utils.misc.input.KeyBinds;
import com.hongminh54.marisaoptimize.utils.network.OnlinePlayers;
...
public class MarisaOptimize implements ClientModInitializer {
    public static final String MOD_ID = "marisa-optimize";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static MarisaOptimize INSTANCE;
    ...
    static {
        ...
        BUILD_NUMBER = MOD_META.getCustomValue(MarisaOptimize.MOD_ID + ":build_number").getAsString();
    }
    ...
    public static Identifier identifier(String path) {
        return Identifier.of(MarisaOptimize.MOD_ID, path);
    }
}
