...
package com.hongminh54.marisaoptimize.systems.profiles;
...
public class Profile implements ISerializable<Profile> {
    ...
    public void delete() {
        try {
            ...
            MarisaOptimize.LOG.error("Error deleting profile {}", name.get(), e);
        }
    }
    ...
    public File getSafeFile() {
        try {
            ...
            MarisaOptimize.LOG.error("Error resolving profile {}", name.get(), e);
            return null;
        }
    }
