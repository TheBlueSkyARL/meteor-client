...
package com.hongminh54.marisaoptimize.systems.modules.combat;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        MarisaOptimize.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        MarisaOptimize.EVENT_BUS.unsubscribe(staticListener);
    }
}
