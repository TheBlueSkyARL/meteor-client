...
package com.hongminh54.marisaoptimize.systems.modules.world;
...
public class StashFinder extends Module {
    ...
    public StashFinder() {
        super(Categories.World, "stash-finder", "Searches loaded chunks for storage blocks. Saves to <your minecraft folder>/marisa-optimize");
    }
    ...
    private void saveCsv() {
        try {
            ...
            MarisaOptimize.LOG.error("Error while writing the stash list to csv", e);
        }
    }
    ...
    private void saveJson() {
        try {
            ...
            MarisaOptimize.LOG.error("Error while writing the stash list to json", e);
        }
    }

    private File getJsonFile() {
        return new File(new File(new File(MarisaOptimize.FOLDER, "stashes"), Utils.getFileWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(MarisaOptimize.FOLDER, "stashes"), Utils.getFileWorldName()), "stashes.csv");
    }
