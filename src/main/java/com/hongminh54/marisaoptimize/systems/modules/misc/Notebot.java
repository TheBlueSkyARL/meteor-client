...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = MarisaOptimize.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    MarisaOptimize.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
