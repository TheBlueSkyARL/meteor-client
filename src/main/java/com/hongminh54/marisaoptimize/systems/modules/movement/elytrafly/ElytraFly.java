...
package com.hongminh54.marisaoptimize.systems.modules.movement.elytrafly;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        MarisaOptimize.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        MarisaOptimize.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        MarisaOptimize.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        MarisaOptimize.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
