...
package com.hongminh54.marisaoptimize.systems.modules;

import it.unimi.dsi.fastutil.objects.Reference2ReferenceOpenHashMap;
import com.hongminh54.marisaoptimize.MarisaOptimize;
import com.hongminh54.marisaoptimize.events.game.GameJoinedEvent;
import com.hongminh54.marisaoptimize.events.game.GameLeftEvent;
import com.hongminh54.marisaoptimize.events.game.OpenScreenEvent;
import com.hongminh54.marisaoptimize.events.meteor.ActiveModulesChangedEvent;
import com.hongminh54.marisaoptimize.events.meteor.KeyEvent;
import com.hongminh54.marisaoptimize.events.meteor.ModuleBindChangedEvent;
import com.hongminh54.marisaoptimize.events.meteor.MouseClickEvent;
import com.hongminh54.marisaoptimize.pathing.BaritoneUtils;
import com.hongminh54.marisaoptimize.settings.Setting;
import com.hongminh54.marisaoptimize.settings.SettingGroup;
import com.hongminh54.marisaoptimize.systems.System;
import com.hongminh54.marisaoptimize.systems.Systems;
import com.hongminh54.marisaoptimize.systems.config.Config;
import com.hongminh54.marisaoptimize.systems.modules.misc.swarm.Swarm;
import com.hongminh54.marisaoptimize.systems.modules.movement.elytrafly.ElytraFly;
import com.hongminh54.marisaoptimize.systems.modules.movement.speed.Speed;
import com.hongminh54.marisaoptimize.systems.modules.render.blockesp.BlockESP;
import com.hongminh54.marisaoptimize.systems.modules.render.marker.Marker;
import com.hongminh54.marisaoptimize.systems.modules.world.Timer;
import com.hongminh54.marisaoptimize.utils.Utils;
import com.hongminh54.marisaoptimize.utils.misc.Keybind;
import com.hongminh54.marisaoptimize.utils.misc.ValueComparableMap;
import com.hongminh54.marisaoptimize.utils.misc.input.Input;
import com.hongminh54.marisaoptimize.utils.misc.input.KeyAction;
...
import com.hongminh54.marisaoptimize.systems.modules.combat.*;
import com.hongminh54.marisaoptimize.systems.modules.misc.*;
import com.hongminh54.marisaoptimize.systems.modules.movement.*;
import com.hongminh54.marisaoptimize.systems.modules.player.*;
import com.hongminh54.marisaoptimize.systems.modules.render.*;
import com.hongminh54.marisaoptimize.systems.modules.world.*;
...
public class Modules extends System<Modules> {
    ...
    void addActive(Module module) {
        synchronized (active) {
            if (!active.contains(module)) {
                active.add(module);
                MarisaOptimize.EVENT_BUS.post(ActiveModulesChangedEvent.get());
            }
        }
    }
    ...
    /***
     * @see com.hongminh54.marisaoptimize.commands.commands.BindCommand
    ...
    private boolean onBinding(boolean isKey, int value, int modifiers) {
        ...
        MarisaOptimize.EVENT_BUS.post(ModuleBindChangedEvent.get(moduleToBind));
        moduleToBind = null;
        ...
        synchronized (active) {
            for (Module module : getAll()) {
                if (module.isActive() && !module.runInMainMenu) {
                    MarisaOptimize.EVENT_BUS.subscribe(module);
                    module.onActivate();
                }
            }
        }
    ...
    private void onGameLeft(GameLeftEvent event) {
        synchronized (active) {
            for (Module module : getAll()) {
                if (module.isActive() && !module.runInMainMenu) {
                    MarisaOptimize.EVENT_BUS.unsubscribe(module);
                    module.onDeactivate();
                }
            }
        }
