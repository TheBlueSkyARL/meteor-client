...
package com.hongminh54.marisaoptimize.systems.hud.elements;
...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = MarisaOptimize.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = MarisaOptimize.identifier("textures/container-transparent.png");
